...
const CheckOut = () => {
  ...
  return (
    <Box p={4} mt={"50px"} background={"#F9E795"} color={"teal"}  >
      <Heading color={"teal"} textAlign={"center"} margin={"10px"} >
        Checkout
      </Heading>
      ...
      <Stack spacing={4} >
        ...
        <Heading as="h2" size="md" color={"teal"} mb={2}>
          Cart Items ({totalItems})
        </Heading>
        <Box height={"200px"} overflowY={"scroll"} background={"#F9E795"} color={"teal"} id="example">
          {cartData.map((item) => (
            <Grid
              key={item._id}
            ...
            >
              <Image
                ...
                padding="10px"
              />
              <Text fontSize={"bolder"}>{item.title}</Text>
              <Text fontSize={"bolder"}>{item.qty}</Text>
        ...
        <Box>
          <Grid templateColumns="repeat(2, 1fr)" gap={4} alignItems="center" background={"#F9E795"} color={"teal"}>
        ...
        <FormControl background={"#F9E795"} color={"teal"}>
