...
const BookCard = ({ book }) => {
  ...
  return (
    ...
    <Box
      ...
      textColor={"black"}
      p={4}
      className="border  rounded-lg overflow-hidden p-4 font-effect-shadow-multiple"
      borderColor={"#F96167"}
      _hover={{
        bg: "teal.300",
        color: "#f8f8ff",
    ...
    >
      ...
      <Button
        ...
        className="w-full p-4 rounded-lg border border-teal-500 hover:bg-teal-300 hover:text-#f8f8ff"
      >
        Add To Cart
      </Button>
    </Box>
